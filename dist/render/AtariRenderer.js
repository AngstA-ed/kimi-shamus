 ...
 */
import { CorridorType, ObjectType } from '../types';
/**
...
export class AtariRenderer {
     ...
     */
    renderRoom(room, levelColor, mazeType) {
    ...
    renderChamber(room, levelColor) {
        ...
        this.ctx.strokeRect(this.GRID_OFFSET_X - 8, this.GRID_OFFSET_Y - 8, this.GRID_SIZE * 3 + 16, this.GRID_SIZE * 3 + 16);
     ...
     */
    renderCorridor(room, corridorType, levelColor) {
        const wallColor = ATARI_COLORS[LEVEL_WALL_COLORS[levelColor]] || '#ffffff';
    ...
    renderPodRoom(room, levelColor) {
        ...
        this.ctx.clearRect(this.GRID_OFFSET_X + this.GRID_SIZE, slitY - 4, this.GRID_SIZE, 8);
    }
    /**
     * Draw a horizontal wall segment
     */
    drawHorizontalWall(wall, color) {
     ...
     */
    drawAngledCorridor(cx, cy, from, to) {
        const size = 60;
        this.ctx.beginPath();
     ...
     */
    drawTJunection(cx, cy, stemDirection) {
        const size = 60;
        this.ctx.beginPath();
...
//# sourceMappingURL=AtariRenderer.js.map